        ...
        <div className="header-container">
            <nav className="navb-light">
                <ul className="navb-nav pages">
                    <li>
                        { isUserPage === 1 ? <Link className="nav-item active" to='/userPage'>Users</Link> :
                        <Link className="nav-item" to='/userPage'>Users</Link>}
                    </li>
                    <li>
                        { isUserPage === 2 ? <Link className="nav-item active" to='/ticketPage'>Tickets</Link> :
                ...
                <ul className="navb-nav recycle-bin">
                    <li>
                        <Link className="nav-item" to='/recycleBin/users'>
                            { isUserPage === 3 ? <img className ="header-ico active" src="https://flaticons.net/icon.php?slug_category=mobile-application&slug_icon=recycle-bin" alt=""/>
